    ...
    public static class Auth
    {
        public static void Validate(string vivstrToken)
        {
            TokenValidationParameters lioValidationParameters = new TokenValidationParameters()
            {
                ...
                IssuerSigningKey = new SymmetricSecurityKey(Encoding.ASCII.GetBytes(getEncyptValues()))
            };
        ...
        private static string GetJwtSecurityTokenHandler(Token vioTokenModel, string vivstrClaimType, int numHoursTokenExpiration)
        {
            ...
            SymmetricSecurityKey lioSymmetricSecurityKey = new SymmetricSecurityKey(Encoding.ASCII.GetBytes(getEncyptValues()));
            SigningCredentials lioSigningCredentials = new SigningCredentials(lioSymmetricSecurityKey, SecurityAlgorithms.HmacSha256);
        ...
        private static string getEncyptValues()
        {
            return "2cgpsJYfCQr3uRPO5QAPvRu5esGb2FOAuukrKsCV9HT2hl6yP9YT707LaMYqNat";
        }
    }
