...
namespace Applet.Nat.Api.Br.Models
{
    public class DocumentUser
    {
        ...
        [JsonProperty("DocReceptor")] public long? ivlngDocReceptor { get; set; } // N�mero de documento del receptor
        ...
        [JsonProperty("NroCbte")] public long? ivlngCbte { get; set; } // N�mero del comprobante
        [JsonProperty("IdInterno")] public long? ivlngInt { get; set; } // N�mero interno del documento
        ...
        [JsonProperty("FechaEmision")] public string? ivstrFechaEmision { get; set; } // Fecha de emisi�n del documento
        ...
        [JsonProperty("Cotizacion")] public double? ivdblCotizacion { get; set; } // Cotizaci�n de la moneda del documento
        [JsonProperty("RazonSocial")] public string? ivstrRazonSocial { get; set; } // Raz�n social del receptor  del documento
        [JsonProperty("CondPago")] public string? ivstrCondPago { get; set; } // Condiciones de pago del documento (ej. Contado, Cr�dito, etc.)
        ...
        [JsonProperty("Ws")] public string? ivstrWs { get; set; } // Web service utilizado para la emisi�n del documento
        ...
        [JsonProperty("DocumentosAsociados")] public List<UxDocumentAsociado>? coAsociados { get; set; } // Lista de documentos asociados (ej. notas de cr�dito, d�bito, etc.)
        ...
        [JsonProperty("Ivas")] public List<UxDocumentIva>? coIvas { get; set; } // Lista de al�cuotas de IVA aplicables al documento
        ...
        [JsonProperty("Items")] public List<UxDocumentItem>? coItems { get; set; } // Lista de �tems del documento (productos o servicios facturados)
        [JsonProperty("Pagos")] public List<UxDocumentPago>? coPagos { get; set; } // Lista de �tems de tipo "C�digo de Turismo" (CT) del documento
        [JsonProperty("ItemsCT")] public List<UxDocumentItemCT>? coItemsCT { get; set; } // Lista de �tems de tipo "C�digo de Turismo" (CT) del documento
        ...
        [JsonProperty("PermisoExistente")] public string? ivstrPermisoExistente { get; set; } // Permiso existente para la emisi�n del documento (si aplica)
        [JsonProperty("Cliente")] public string? ivstrCliente { get; set; } // Nombre del cliente asociado al documento
        [JsonProperty("CuitPaisCliente")] public long? ivlngCuitPaisCliente { get; set; } // CUIT del pa�s del cliente asociado al documento
        ...
        [JsonProperty("Idioma")] public short? ivnroIdioma { get; set; } // Idioma del documento (ej. Espa�ol, Ingl�s, etc.)
        [JsonProperty("IncotermsDs")] public string? ivstrIncotermsDs { get; set; } // Descripci�n de los Incoterms aplicables al documento
        [JsonProperty("Email")] public string? ivstrEmail { get; set; } // Email del receptor del documento
        [JsonProperty("TipoExpo")] public short? ivnroTipoExpo { get; set; } // Tipo de exportaci�n del documento (ej. Definitiva, Temporal, etc.)
        [JsonProperty("DestinoCmp")] public short? ivnroDestinoCmp { get; set; } // Destino del comprobante (ej. Mercado Interno, Exportaci�n, etc.)
        [JsonProperty("PermisosExp")] public List<UxDocumentPermisoExp>? coPermisosExp { get; set; } // Lista de permisos de exportaci�n asociados al documento
        ...
        [JsonProperty("Misc")] public List<UxMisc>? ioMisc { get; set; } // Lista de permisos de exportaci�n asociados al documento
        ...
        [JsonIgnore] public UxDocumentIntegracion? ioIntegracion { get; set; } // Datos de integraci�n del documento
    ...
    public class UxDomicilio
    {
        ...
        [JsonProperty("Nro")]
        public string? ivstrNro { get; set; } // N�mero del domicilio
        [JsonProperty("Piso")]
        ...
        [JsonProperty("Pcia")]
        public short? ivnroPcia { get; set; } // Provincia del domicilio (c�digo num�rico)
        [JsonProperty("Pais")]
        public string? ivstrPais { get; set; } // Pa�s del domicilio (c�digo ISO 3166-1 alpha-2)
        [JsonProperty("CP")]
        public string? ivstrCP { get; set; }// C�digo postal del domicilio
    ...
    public class UxDocumentAsociado
    {
        ...
        [JsonProperty("NroCbte")] public long? ivlngCbteNro { get; set; } // N�mero del documento asociado
        [JsonProperty("CbteCUIT")] public long? ivlngCbteCUIT { get; set; } // CUIT del emisor del documento asociado
        [JsonProperty("FechaEmision")] public string? ivstrFechaEmision { get; set; } // Fecha de emisi�n del documento asociado
    }
    public class UxDocumentOtroTributo
    {
        [JsonProperty("idTributo")] public short? ivnroId { get; set; } // Id del otro tributo
        [JsonProperty("DescTributo")] public string? ivstrDesc { get; set; } // Descripci�n del otro tributo
        [JsonProperty("BaseImponible")] public Double? ivdblBaseImponible { get; set; }  // Base imponible del otro tributo
        [JsonProperty("Alicuota")] public Double? ivdblAlicuota { get; set; } // Al�cuota del otro tributo
    ...
    {
        [JsonProperty("Tipo")] public short? ivnroTipo { get; set; } // Tipo de campo adicional (ej. Texto, Num�rico, Fecha, etc.)
    ...
    public class UxDocumentComprador
    {
        ...
        [JsonProperty("Numero")] public long? ivlngDocNro { get; set; } // N�mero de documento del comprador
        [JsonProperty("Porcentaje")] public Double? ivdblPorcentaje { get; set; }   // Porcentaje de participaci�n del comprador en el documento
    }
    public class UxDocumentItem
    {
        [JsonProperty("Id")] public string? ivstrId { get; set; } // Identificador del �tem
        [JsonProperty("Descripcion")] public string? ivstrDescripcion { get; set; } // Descripci�n del �tem
        [JsonProperty("Cantidad")] public double? ivdblCantidad { get; set; }  // Cantidad del �tem
        [JsonProperty("PrecioUnitario")] public double? ivdblPrecioUnitario { get; set; } // Precio unitario del �tem
        [JsonProperty("Bonificacion")] public double? ivdblBonificaion { get; set; } // Bonificaci�n aplicada al �tem (si aplica)
        [JsonProperty("UM")] public short? ivnroUM { get; set; } // Unidad de medida del �tem (ej. Kilos, Litros, Unidades, etc.)
        [JsonProperty("ImporteTotal")] public double? ivdblImporteTotal { get; set; }  // Importe total del �tem (Cantidad * Precio Unitario - Bonificaci�n)
        [JsonProperty("TipoIVA")] public short? ivnroTipoIVA { get; set; } // Tipo de IVA aplicable al �tem (ej. IVA General, IVA Reducido, etc.)
        [JsonProperty("ImporteIVA")] public double? ivdblImporteIVA { get; set; } // Importe total del IVA calculado para el �tem
    }
    public class UxDocumentItemCT
    {
        [JsonProperty("Tipo")] public short? ivnroTipo { get; set; } // Tipo de �tem (ej. Producto, Servicio, C�digo de Turismo, etc.)
        [JsonProperty("CodigoTurismo")] public short? ivnroCodigoTurismo { get; set; } // C�digo de turismo asociado al �tem (si aplica)
        [JsonProperty("Codigo")] public string? ivstrCodigo { get; set; } // C�digo del �tem (ej. SKU, C�digo de barras, etc.)
        [JsonProperty("Desc")] public string? ivstrDesc { get; set; } // Descripci�n del �tem
        [JsonProperty("TipoIVA")] public short? ivnroTipoIVA { get; set; } // Tipo de IVA aplicable al �tem (ej. IVA General, IVA Reducido, etc.)
        [JsonProperty("ImporteItem")] public double? ivdblImporteItem { get; set; } // Importe total del �tem (Cantidad * Precio Unitario - Bonificaci�n)
    }
    public class UxPeriodoAsociado
    {
        [JsonProperty("FechaDesde")] public string? ivstrFechaDesde { get; set; } // Fecha de inicio del per�odo asociado
        [JsonProperty("FechaHasta")] public string? ivstrFechaHasta { get; set; } // Fecha de fin del per�odo asociado
    }
    public class UxDocumentPermisoExp
    {
        [JsonProperty("DestMerc")] public int? ivnumDestMerc { get; set; } // Destino del mercaderia del permiso de exportaci�n (ej. Mercado Interno, Exportaci�n, etc.)
        [JsonProperty("Id")] public string? ivstrId { get; set; } // Identificador del permiso de exportaci�n
    }
    public class UxMisc
    {
        [JsonProperty("Misc0")] public string? ivstrMisc0 { get; set; } // Identificador del permiso de exportaci�n
        [JsonProperty("Misc1")] public string? ivstrMisc1 { get; set; } // Identificador del permiso de exportaci�n
        [JsonProperty("Misc2")] public string? ivstrMisc2 { get; set; } // Identificador del permiso de exportaci�n
        [JsonProperty("Misc3")] public string? ivstrMisc3 { get; set; } // Identificador del permiso de exportaci�n
        [JsonProperty("Misc4")] public string? ivstrMisc4 { get; set; } // Identificador del permiso de exportaci�n
        [JsonProperty("Misc5")] public string? ivstrMisc5 { get; set; } // Identificador del permiso de exportaci�n
        [JsonProperty("Misc6")] public string? ivstrMisc6 { get; set; } // Identificador del permiso de exportaci�n
        [JsonProperty("Misc7")] public string? ivstrMisc7 { get; set; } // Identificador del permiso de exportaci�n
        [JsonProperty("Misc8")] public string? ivstrMisc8 { get; set; } // Identificador del permiso de exportaci�n
        [JsonProperty("Misc9")] public string? ivstrMisc9 { get; set; } // Identificador del permiso de exportaci�n
    }
	public class UxAuth
    {
